...
class Analycis:
    ...
    def showTreeMap(self, title, data):
        ...
        treemap.add("广州", data, is_label_show=True, label_pos='inside', label_text_size=19)
        treemap.render(r"c:\Users\Administrator\graduation design\spiderResult1\广州各区每平每月房租单价统计.html")

# 展示条形图
    def showLine1(self, title, attr, value):
        from pyecharts import Bar
        bar = Bar(title)
        bar.add("广州", attr, value, is_convert=False, is_label_show=True, label_text_size=18, is_random=True,
                # xaxis_interval=0, xaxis_label_textsize=9,
                legend_text_size=18, label_text_color=["#000"])
        bar.render(r"c:\Users\Administrator\graduation design\spiderResult1\样本数量统计.html")

    def showLine2(self, title, attr, value):
        from pyecharts import Bar
        bar = Bar(title)
        bar.add("广州", attr, value, is_convert=False, is_label_show=True, label_text_size=18, is_random=True,
                # xaxis_interval=0, xaxis_label_textsize=9,
                legend_text_size=18, label_text_color=["#000"])
        bar.render(r"c:\Users\Administrator\graduation design\spiderResult1\户型统计.html")

    def showLine3(self, title, attr, value):
        from pyecharts import Bar
        bar = Bar(title)
        bar.add("广州", attr, value, is_convert=False, is_label_show=True, label_text_size=18, is_random=True,
                # xaxis_interval=0, xaxis_label_textsize=9,
                legend_text_size=18, label_text_color=["#000"])
        bar.render(r"c:\Users\Administrator\graduation design\spiderResult1\广州各区每平每日房租单价统计.html")
    ...
    def showPyechartsWordCloud(self, attr, value):
        ...
        wordcloud.render(r"c:\Users\Administrator\graduation design\spiderResult1\租房信息词云.html")
...
#生成词云图片
analycis.getTitle()
analycis.showWorkCloud(analycis.getTitle(), "docker.jpg", "kh.ttf", out_filename="租房信息词云.jpg")
...
print((attr, value))
analycis.showPyechartsWordCloud(attr,value)


# # #统计租房面积
(attr, value) = analycis.getAcreage()
analycis.showPie2("租房面积统计", attr, value)

# # # 户型统计
(attr, value) = analycis.getRooms()
analycis.showLine2("户型统计", attr, value)

# # 获取每月每平方米多少钱
data = analycis.getTotalAvgPrice()
print(data)
analycis.showTreeMap("广州各区房租单价：平方米/月", data)
#
#
# # # 获取每日每平方米多少钱
(attr, value) = analycis.getTotalAvgPricePerDay()
print(attr, value)
analycis.showLine3(title="各区房租单价：平方米/日", attr=attr, value=value)
#
# # 样本数量统计
(attr, value) = analycis.getAnalycisNum()
print(attr, value)
analycis.showLine1(title="统计样本数量", attr=attr, value=value)
#
# # 房源分布
(attr, value) = analycis.getAreaWeight()
print(attr, value)
analycis.showPie1("广州房源分布", attr, value)